...
const WarningView = ({ onAccept, onCancel }: { onAccept: () => void; onCancel: () => void; }) => (
    <div className="flex flex-col items-center justify-center text-center p-4 space-y-6 h-full">
        ...
        <Alert variant="destructive" className="text-left">
            ...
            <AlertDescription>
                Este generador creará un plan de entrenamiento basado únicamente en la información que proporcionaste al registraste. El plan generado por la IA (Inteligencia Artificial) no será revisado por un coach o administrador de Kali Gym. Eres responsable de entrenar de forma segura.
            </AlertDescription>
        </Alert>
